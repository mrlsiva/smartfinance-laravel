									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="d-flex justify-content-start flex-column">
												<a href="{{route('user', ['id' => $finance->user->id,'flag' => 'user'])}}" class="text-dark fw-bolder text-hover-primary fs-6">{{$finance->user->first_name}} {{$finance->user->last_name}}</a>
                ...
                <div class="mb-10">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="selectform" method="post" action="{{route('store_next_month_payment')}}" enctype="multipart/form-data">
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="number" class="form-control form-control-solid @error('amount') is-invalid @enderror" placeholder="Investment Amount" value="" name="amount" id="amount" onkeydown="if(event.key==='.'){event.preventDefault();}" onpaste="let pasteData = event.clipboardData.getData('text'); if(pasteData){pasteData.replace(/[^0-9]*/g,'');} " />
                            <!--end::Input-->
