...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0 parent-active">
                                ...
                                <a href="#" onclick="loan()" class="text-dark fw-bold fs-6 col bg-light-warning p-6 rounded-2 me-7 mb-7" id="loan_management">
                                ...
                                <a href="#" onclick="tax()" class="text-dark fw-bold fs-6 col bg-light-warning p-6 rounded-2 me-7 mb-7" id="tax_management">
        ...
        @if($user->is_profile_verified == 1)
            ...
            <div class="" id="loan" style="display:none;">
                @if($loan != NULL)
                    <!--begin::Row-->
                    <div class="row gy-5 g-xl-8 mt-xl-5" id="finance" >
                        <!--begin::Col-->
            ...
            <div class="" id="tax" style="display:none;">
                @if($tax != NULL)
                    <!--begin::Row-->
                    <div class="row gy-5 g-xl-8 mt-xl-5" id="tax" >
                        ...
                        <div class="col-xl-12 ">
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-dark">Taxation Details</span>
                                    </h3>
                                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Next Tax">
