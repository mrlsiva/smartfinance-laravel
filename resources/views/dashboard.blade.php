                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0 parent-active">
                                ...
                                <a href="#" onclick="tax()" class=" {{('tax'== $flag)?'active':''}} text-dark fw-bold fs-6 col border-bottom border-warning bg-light-warning p-6 rounded-2 me-7 mb-7" id="tax_management">
