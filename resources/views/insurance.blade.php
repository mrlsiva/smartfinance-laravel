                                ...
                                @else
                                    <a href="{{route('user_management')}}"  class="text-dark fw-bold fs-6 col  border-bottom border-secondary  p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white bg-success" >{{$user_count}}</span>
                                            </span>
                                        </div>
                                        User Management
                                    </a>
                                ...
                                @else
                                   <a href="{{route('finance')}}" class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">                                   
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white bg-success">{{$smartfinance_count+$payment_count}}</span>
                                            </span>
                                        </div>
                                        Smart Finance
                                    </a> 
                                ...
                                @else
                                    <a href="{{route('loan')}}" class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white bg-success">{{$loan_count+$loan_payment_count}}</span>
                                            </span>
                                        </div>
                                        Loan
                                    </a>
                                ...
                                @else
                                    <a href="{{route('tax')}}"class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <!-- <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white bg-success">{{$tax_count}}</span>
                                            </span> -->
                                        </div>
                                        Taxation
                                    </a>
                                ...
                                @else
                                    <a href="{{route('mutual_fund')}}" class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <!-- <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white bg-success" >{{$mutual_fund_count}}</span>
                                            </span> -->
                                        </div>
                                        Mutual Fund
                                    </a>
