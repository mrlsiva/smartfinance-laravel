...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0 parent-active">
                                ...
                                <a href="{{route('insurance')}}" class="active text-dark fw-bold fs-6 col border-bottom border-warning bg-light-warning p-6 rounded-2 me-7 mb-7">                            
                                    <div class="d-flex flex-stack flex-grow-1">
                                        <div class="d-flex flex-column me-2">       
                                            <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
        ...
        @php
            ...
            $insurance = DB::table('insurances')->where('user_id',$user->id)->first();
        @endphp
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark">Insurance Management</span>
                                    ...
                                    <tbody class="">
                                       @foreach($insurances as $insurance)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-45px me-5">
                                                        @php
                                                            $avatar = App\Models\UserDetail::where('user_id',$insurance->user->id)->first();
                                                        @endphp
                                                        @if($avatar != NULL)
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="{{route('user', ['id' => $insurance->user->id,'flag' => 'insurance'])}}" class="text-dark fw-bolder text-hover-primary fs-6">{{$insurance->user->first_name}} {{$insurance->user->last_name}}</a>
                                                        <span class="text-muted fw-bold text-muted d-block fs-7">#{{$insurance->user->id}}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{$insurance->category}}</td>
                                            <td>Rs {{$insurance->commafun($insurance->amount)}}</td>
                                            <td>{{$insurance->tenure}} Year</td>
                                            @php
                                            ...
                                            <td>{{$date}}</td>
                                            <td>
                                            	<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" href="{{route('view_insurance', ['id' => $insurance->id])}}">
                        ...
                        <div class="col-xl-12 mb-5 mb-xl-10">
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-header pt-7">
                                    <!--begin::Title-->
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-dark">My Insurances</span>
                                    </h3>
                                    <!--end::Title-->
                                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Next Insurance">
                                        <a class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_insurance">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                            ...
                                            <!--begin::Table body-->
                                            <tbody class="">
                                            	@foreach($admin_insurances as $admin_insurance)
                                            	<tr>
                                            		<td>
                                            			<div class="d-flex align-items-center">
                                            				<div class="symbol symbol-45px me-5">
                                            					@php
                                            					$avatar = App\Models\UserDetail::where('user_id',$admin_insurance->user->id)->first();
                                            					@endphp
                                            					@if($avatar != NULL)
                                            					<img src="{{ $avatar->avatar}}" alt="" />
                                            					@endif
                                            				...
                                            				<div class="d-flex justify-content-start flex-column">
                                            					<a href="{{route('user', ['id' => $admin_insurance->user->id,'flag' => 'insurance'])}}" class="text-dark fw-bolder text-hover-primary fs-6">{{$admin_insurance->user->first_name}} {{$admin_insurance->user->last_name}}</a>
                                            					<span class="text-muted fw-bold text-muted d-block fs-7">#{{$admin_insurance->user->id}}</span>
                                            				</div>
                                            			</div>
                                            		</td>
                                            		<td>{{$admin_insurance->category}}</td>
                                            		<td>Rs {{$admin_insurance->commafun($admin_insurance->amount)}}</td>
                                            		<td>{{$admin_insurance->tenure}} Year</td>
                                            		@php
                                            		$date = Carbon\Carbon::parse($admin_insurance->start_date)->formatLocalized('%d %b %Y');
                                            		@endphp
                                            		<td>{{$date}}</td>
                                            		@php
                                            		$date = Carbon\Carbon::parse($admin_insurance->end_date)->formatLocalized('%d %b %Y');
                                            		@endphp
                                            		<td>{{$date}}</td>
                                            		<td>
                                            			<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" href="{{route('view_insurance', ['id' => $admin_insurance->id])}}">
                                            				<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
                                            				<span class="svg-icon svg-icon-2">
                                            					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            						<rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="black"></rect>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-px text-center pt-15 pb-15">
                                    <!--begin::Title-->
                                    <h2 class="fs-2x fw-bolder mb-0">Store Your Insurance Details Here </h2>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <p class="text-gray-400 fs-4 fw-bold py-7">Click on the below button to start storing the details </p>
                                    <!--end::Description-->
                                    <!--begin::Action-->
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_insurance" style="color: white;">Start Insurance</button>
                                    <!--end::Action-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Illustration-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="mb-10">
                    ...
                    <!--end::Heading-->
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" action="{{route('save_insurance')}}" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Input group-->
                        <div class="fv-row mb-8">
                            <!--begin::Label-->
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select..." name="category" id="category">
                        ...
                        <div id="sub_category" style="display: none;">
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Sub Category"></i>
                                </label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select..." name="sub_category" id="sub_category">
                                	<option value="">Select</option>
                        ...
                        <div id="other_category" style="display: none;">
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                    <span class="required">Other Category</span>
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Other Category"></i>
                                </label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="Other Category" value="" name="other_category" id="other_category" required="true" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="number" class="form-control form-control-solid" placeholder="Amount" value="" name="amount" id="amount" required="true" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="required">Tenure Years</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Tenure Years"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="number" class="form-control form-control-solid" placeholder="Tenure Years" value="" name="tenure" id="tenure" required="true" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Start Date"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            @php
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="End Date"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="date" class="form-control form-control-solid" placeholder="End Date" value="" name="end_date" id="end_date" required="true" />
                            <!--end::Input-->
                            <div class="end_date_error" id="end_date_error"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="required">Payment Due</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Payment Due"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select..." name="payment_due" id="payment_due">
                            	<option value="">Select</option>
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="">Policy Document (*You can choose and upload multiple documents at a same time)</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Policy Document"></i>
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="file" class="form-control form-control-solid custom-file-input" id="policy_document" placeholder="Policy Document" value="" name="policy_document[]" required="true" multiple />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
    ...
    jQuery(document).ready(function ()
    {
        jQuery('input[name="end_date"]').on('change',function(){
            ...
            if(end_date <= start_date){
                alertText = "End Date should to greater than start date.";
                var div = document.getElementById("end_date_error");
                div.innerHTML = '';
