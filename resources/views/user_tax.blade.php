                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0 parent-active">
                                ...
                                <a href="{{route('tax')}}" class="active text-dark fw-bold fs-6 col bg-light-warning p-6 rounded-2 me-7 mb-7">
                                ...
                                <a href="{{route('insurance')}}" class="text-dark fw-bold fs-6 col bg-light-success p-6 rounded-2 me-7 mb-7">                                   
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <span class="symbol symbol-50px">
                                            <span class="px-3 py-1 fs-5 fw-bolder bg-success text-white">{{$insurance_count}}</span>
                                        </span>
                                    </div>
                                    Insurance
                                </a>
