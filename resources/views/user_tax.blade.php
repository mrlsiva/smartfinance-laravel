                            ...
                            <div class="row g-0">
                                ...
                                <a href="{{route('mutual_fund')}}" class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <!-- <span class="symbol symbol-50px">
                                            <span class="px-3 py-1 fs-5 fw-bolder text-white" style="background-color: #B5B5C3;">0</span>
                                        </span> -->
                                    </div>
                                    Mutual Fund
                                </a>
                                @if($insurance_count == 0)
                                    <a href="{{route('insurance')}}" class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">                            
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <!-- <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white" style="background-color: #B5B5C3;">{{$insurance_count}}</span>
                                            </span> -->
                                        </div>
                                        Insurance
                                    </a>
                                @else
                                    <a href="{{route('insurance')}}" class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">                            
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <!-- <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white bg-success" >{{$insurance_count}}</span>
                                            </span> -->
                                        </div>
                                        Insurance
                                    </a>
