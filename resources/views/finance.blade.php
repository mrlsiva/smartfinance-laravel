...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0 parent-active">
                                ...
                                <a href="{{route('finance')}}" class="active text-dark fw-bold fs-6 col border-bottom border-warning bg-light-warning p-6 rounded-2 me-7 mb-7">                                   
                                    <div class="d-flex flex-stack flex-grow-1">
                                        <div class="d-flex flex-column me-2">       
                                            <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
        ...
        @if($user->is_profile_verified == 1)
            <input type="hidden" name="base_url" id="base_url" value="{{url('finance')}}">
            ...
            <!--begin::Row-->
            <div id="admin_finance" id="admin_finance">
