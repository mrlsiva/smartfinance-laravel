                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0">
                                ...
                                @if($insurance_count->count() == 0)
                                    <a href="{{route('insurance')}}" class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">                            
                                        <div class="d-flex flex-stack flex-grow-1">
                                            <div class="d-flex flex-column me-2">       
                                                <span class="svg-icon svg-icon-3x d-block my-2" style="background-color: #F5F8FA;">
                                ...
                                @else
                                    <a href="{{route('insurance')}}" class="text-dark fw-bold fs-6 col border-bottom border-secondary p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">                            
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white bg-success" >{{$insurance_count->count()}}</span>
                                            </span>
                                        </div>
                                        Insurance
                                    </a>
