                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0">
                                ...
                                @if($insurance_count->count() == 0)
                                    <a href="{{route('insurance')}}" class="text-dark fw-bold fs-6 col border-bottom border-warning p-6 rounded-2 me-7 mb-7" style="background-color: #F5F8FA;">                            
                                        <div class="d-flex flex-stack flex-grow-1">
                                            <div class="d-flex flex-column me-2">       
                                                <span class="svg-icon svg-icon-3x d-block my-2" style="background-color: #F5F8FA;">
                                            ...
                                            <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder text-white" style="background-color: #B5B5C3;">{{$insurance_count->count()}}</span>
                                            </span>
                                        </div>
                                        Insurance
                                    </a>
                                @else
                                    <a href="{{route('insurance')}}" class="text-dark fw-bold fs-6 col border-bottom border-success p-6 rounded-2 me-7 mb-7 bg-light-success" >                            
                                        <div class="d-flex flex-stack flex-grow-1">
                                            <div class="d-flex flex-column me-2">       
                                                <span class="svg-icon svg-icon-3x d-block my-2 svg-icon-success" >
                                                    <svg xmlns="http://www.w3.org/2000/svg" style="vertical-align: -0.125em;" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1024 1024"><path fill="currentColor" d="M128 384h768v-64a64 64 0 0 0-64-64H192a64 64 0 0 0-64 64v64zm0 64v320a64 64 0 0 0 64 64h640a64 64 0 0 0 64-64V448H128zm64-256h640a128 128 0 0 1 128 128v448a128 128 0 0 1-128 128H192A128 128 0 0 1 64 768V320a128 128 0 0 1 128-128z"></path><path fill="currentColor" d="M384 128v64h256v-64H384zm0-64h256a64 64 0 0 1 64 64v64a64 64 0 0 1-64 64H384a64 64 0 0 1-64-64v-64a64 64 0 0 1 64-64z"></path></svg>
                                                </span>         
                                            </div>
                                            <span class="symbol symbol-50px">
                                                <span class="px-3 py-1 fs-5 fw-bolder bg-success text-white">{{$insurance_count->count()}}</span>
                                            </span>
                                        </div>
                                        Insurance
                                    </a>
